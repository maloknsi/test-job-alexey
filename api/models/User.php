...
class User extends \common\models\User implements IdentityInterface
{
	...
	public function generateAccessToken($saveNow = true)
	{
		$this->user_auth_token = sha1(md5(rand(1000, time()))) . "_" . time();
		return ($saveNow) ? ($this->save() ? 1 : 0) : 1;
	}
